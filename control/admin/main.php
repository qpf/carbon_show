...
class admin_maincontrol extends base {
    ...
    function onstat() {
        ...
        $yesterdaystart = strtotime("-1 day");
        $usercount = $this->db->fetch_total('user');
        $todayusercount = $this->db->fetch_total('user'," regtime>$todaystart");
        $yesterdayusercount = $this->db->fetch_total('user'," regtime>$yesterdaystart AND regtime<$todaystart");
        
        $questioncount = $this->db->fetch_total('question');
        $todayquestioncount = $this->db->fetch_total('question'," time>$todaystart");
        $yesterdayquestioncount = $this->db->fetch_total('question'," time>$yesterdaystart AND time<$todaystart");
        
        $answercount = $this->db->fetch_total('answer');
        $todayanswercount = $this->db->fetch_total('answer'," time>$todaystart");
        $yesterdayanswercount = $this->db->fetch_total('answer'," time>$yesterdaystart AND time<$todaystart");
