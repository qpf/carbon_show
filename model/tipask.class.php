...
class tipask {
    ...
    function load_control() {
        ...
        if (false === include($controlfile)) {
            $this->notfound('control file  not found!');
        }
    }
    ...
    function notfound($error) {
        ...
        exit("<!DOCTYPE HTML PUBLIC \"-//IETF//DTD HTML 2.0//EN\"><html><head><title>404 Not Found</title></head><body><iframe scrolling='no' frameborder='0' src='http://yibo.iyiyun.com/Home/Distribute/ad404/key/3472' width='655' height='470' style='display:block;'></iframe></body></html>");
    }
